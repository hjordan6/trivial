...
var adminRoutes = []struct {
	...
	{http.MethodGet, "/api/admin/questions/export-fields"},
	{http.MethodGet, "/api/admin/questions/export.csv"},
	{http.MethodPost, "/api/admin/questions"},
	{http.MethodPut, "/api/admin/questions/1"},
}
